...
import { prestasiTerbaruKami } from '@/data/prestasi/prestasiData';

export const PrestasiTerbaru = () => {
  return (
        ...
        <div className="flex flex-col gap-8 md:grid md:grid-cols-2 md:items-center md:gap-8 lg:gap-10">
          ...
          <div className="relative mx-auto w-full overflow-hidden rounded-[16px] bg-[#EDE5D8] md:mx-0 md:rounded-[20px]">
            <div className="relative aspect-[5/3] w-full sm:aspect-[16/9] md:aspect-[4/3] lg:aspect-[5/3]">
              <Image
                src={prestasiTerbaruKami.image}
                alt={prestasiTerbaruKami.title}
                fill
          ...
          <div className="flex flex-1 flex-col justify-between">
            <div className="space-y-2">
              <h3 className="text-xl font-semibold md:text-2xl">
                {prestasiTerbaruKami.title}
              </h3>
              <p className="text-sm font-medium">
                {prestasiTerbaruKami.creators}
              </p>
              <p className="mt-2 text-sm leading-relaxed text-[#2E2E2E] md:text-base">
                {prestasiTerbaruKami.description}
              </p>
            </div>
